...
export type AIFeature =
  ...
  | 'RESOURCE_CAPACITY_INTELLIGENCE';
...
export type AIAuditEventType =
  ...
  | 'FINANCE_AI_QUERY'
  | 'FINANCE_AI_RESPONSE_GENERATED'
  | 'FINANCE_AI_RESPONSE_VALIDATION_FAILED'
  | 'FINANCE_AI_DATA_ACCESSED'
  | 'FINANCE_AI_RECOMMENDATION_GENERATED'
  | 'FINANCE_AI_FEEDBACK_SUBMITTED'
  | 'FINANCE_METRIC_VIEWED'
  | 'FINANCE_COMPARISON_VIEWED';
